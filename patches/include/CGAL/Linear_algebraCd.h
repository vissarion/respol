...
public:
  ...
  static 
  void   destructive_Gaussian_elimination(Matrix &M,
            Matrix &L,// Matrix &U,
            std::vector<int> &row_permutation,
            std::vector<int> &column_permutation,
            FT &det, int &rank, Vector &c);
  ...
  static
  FT     destructive_determinant(Matrix &M, Matrix &L,// Matrix &U,
             std::vector<int> &q, Vector &c);
  static
  FT     destructive_determinant(Matrix &M);

  static
  Sign   destructive_sign_of_determinant(Matrix &M);
